...
- Add a global toggle to enable/disable all resources in the chart ([#21](https://github.com/giantswarm/rook-operator-app/pull/21)).
...
[Unreleased]: https://github.com/giantswarm/rook-operator-app/compare/v0.2.0...HEAD
